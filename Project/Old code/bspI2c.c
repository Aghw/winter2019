...
//void I2C_SendBuffer(I2C_TypeDef *i2c, uint8_t *buffer, uint16_t bufLength)
//{    
//    for (int i = 0; i < bufLength; i++) {
//        while(!I2C_GetFlagStatus(i2c, I2C_FLAG_TXE)); 
//        I2C_SendData(i2c, buffer[i]);
//        while(!I2C_GetFlagStatus(I2C1, I2C_FLAG_RXNE));
//        SPI_I2S_ReceiveData(I2C1);
//    }
// }
//
//// SPI_GetBuffer
...
//void I2C_GetBuffer(SPI_TypeDef *spi, uint8_t *buffer, uint16_t bufLength)
//{
//    int iread = 0;
//
//    for (int i = 0; i < bufLength; i++) {
...
//void I2C_SetDataRate(SPI_TypeDef *spi, uint16_t value)
//{
//  uint16_t tmpreg = 0;
//  tmpreg = spi->CR1;
